...
const metrics = [
  ...
  {
    name: 'Gjennomsnittlig Ordreverdi',
  ...
  return (
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-7xl mx-auto space-y-8">
        {/* Header */}
        <div>
          <h1 className="font-norse text-4xl mb-2">Dashboard</h1>
          <p className="text-stone-600">Oversikt over salg og kunder</p>
        </div>
